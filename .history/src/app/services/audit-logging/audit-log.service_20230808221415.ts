...
export class AuditLogService {
  ...
  logAction(userId: string, action: string, timestamp: string, targetDocumentId: string, module: string) {
    const logEntry = { userId, action, timestamp, targetDocumentId, module };
